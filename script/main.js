let navBtn = document.getElementById("navigation-button");
let navIcon = document.querySelector("#navigation-icon");
let navFlag = false;
...
let portBtns = document.getElementsByClassName("port-btn");
...
function replaceDefaultStyle(curr, next){
    let elements = document.querySelectorAll("[class*=" +curr + "]");
